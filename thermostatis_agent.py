...
class InteroceptiveAgent:
    ...
    def update_world(self):
        ...
        if self.time == 50:
            # jump by 2 (to 2)
            temp_change_instant_update = 2
        elif self.time == 100:
            # jump by 3 (to 5)
            temp_change_instant_update = 3
        elif self.time == 150:
            # jump by -6 (to -1)
            temp_change_instant_update = -6
        elif self.time == 200:
            # jump by -5 (to -6)
            temp_change_instant_update = -5
        elif self.time == 250:
            # jump by +6 (to 0)
            temp_change_instant_update = 6
        else:
            # stay at 0
            temp_change_instant_update = 0
    ...
    def upd_light_change(self):
        ...
        # set the light change due to velocity 
        ...
        light_change = self.light_change_environment[-1] + self.light_change_movement[-1]
    ...
    def upd_temp_change(self):
        ...
        # first update by instant change in temperature change
...
class ExteroceptiveAgent(InteroceptiveAgent):
    ...
    def update_world(self):
        ...
        light_change_const = self.light_change_environment[-1] + light_change_instant

        self.light_change_environment.append(light_change_const)
...
class ActiveExteroception(ExteroceptiveAgent):
    ...
    #         # self.temp_change_environment[-1] += -self.aex_action[-1]
    ...
    def upd_aex_err_z_1(self):
        ...
        self.aex_e_z_1.append(self.ex_sense[-1] - 1.0 * (-self.mu_d2[-1]))
        # self.aex_e_z_1.append(self.ex_sense[-1] - 1.0 * (self.mu_d1[-1]))
...
class ProprioceptiveAgent(ActiveExteroception):
    ...
    #         # self.temp_change_environment[-1] += -action / 1.0

    #         # self.temp_change_environment[-1] += -self.pr_action[-1]
    #         # self.temp_change_environment[-1] += -self.pr_action_effect_on_light[-1] / 1.0
    ...
    #     # upd += self.temp_change_environment[-1]
