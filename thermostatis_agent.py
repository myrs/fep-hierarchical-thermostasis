...
class InteroceptiveAgent:
    ...
    def __init__(self, s_z_0=0.1, s_z_1=0.1, s_w_0=0.1, s_w_1=0.1,
        ...
        self.int_action_bound = action_bound
    ...
    def plot_results(self):
        ...
        ax[2][0].plot(timeline, self.int_action[1:])
        diff = np.array(self.temp_const_change[1:]) + np.array(self.int_action[1:])
...
class ActiveExteroception(ExteroceptiveAgent):
    ...
    def update_world(self):
        ...
        if not self.supress_action:
            ...
            light_action_change = self.light_action_change[-1] + upd
            self.light_action_change.append(light_action_change)


    def upd_light_change(self):
        super().upd_light_change()

        self.light_change[-1] += self.light_action_change[-1]
...
class ProprioceptiveAgent(ActiveExteroception):
    ...
    def upd_ex_err_z_0(self):
        ...
        proprioception_prediction = self.light_action_change[-1]
