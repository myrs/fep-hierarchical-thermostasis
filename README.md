...
It is logical to assume that agent's beliefs its sensory data is directly generated by <img src="https://latex.codecogs.com/png.latex?%5Cinline%20%5Cmu" atl="\mu">. Therefore sensory data generation up to second order can be described as:
